...
LastEditTime: 2022-05-08 18:43:11
Description: 
'''
import time
...
class ECMoveTT(BaseEC):
    # 透传运动部分
    def TT_init(self, t: int = 10, lookahead: int = 400, smoothness: float = 0.1, response_enable: int = None):
        """机器人透传初始化
    ...
    def TT_start_joint(self,joint: list):
    ...
    def TT_add_joint(self,joint: list):
        """透传目标关节点到缓存
    ...
    def TT_add_pose(self, pose: list):
        """添加透传目标位姿点到缓存
